...
# Resolve model path relative to this file's location, not the working directory
...
class CarClassifierResNet(nn.Module):
    def __init__(self, num_classes=6, dropout_rate=0.664):
        super().__init__()
        ...
        # dropout_rate matches the best trial from hyperparameter tuning (0.664)
